...
public class MainActivity extends ListActivity {
        ...
        lv.setOnItemClickListener(new OnItemClickListener() 
        {
            ...
            public void onItemClick(AdapterView<?> parent, View view,int position, long id)
            {
                ...
                String address = ((TextView) view.findViewById(R.id.address))
                        .getText().toString();
                String phno = ((TextView) view.findViewById(R.id.mobile))
                        .getText().toString();
              //  String email = ((TextView) view.findViewById(R.id.email))
                ...
                in.putExtra(TAG_PHONE_MOBILE, phno);
  //              in.putExtra(TAG_EMAIL, email);
    ...
    /**
     * Asynchronous task class to get json by making HTTP call
     * */
        ...
        protected void onPostExecute(Void result) {
            ...
            ListAdapter adapter = new SimpleAdapter(
                    ...
                    R.layout.list_item, new String[] { TAG_NAME, TAG_ADDRESS,
                            TAG_PHONE_MOBILE,TAG_EMAIL }, new int[] { R.id.name,
