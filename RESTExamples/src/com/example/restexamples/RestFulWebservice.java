...
public class RestFulWebservice extends Activity {
	private RestFulWebservice activity = null;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.rest_ful_webservice);  
    	        ...
    	        RESTWSTask wst = new RESTWSTask(HttpsClientUtils.POST_TASK,this,"Getting booking status details...");
    ...
    public class RESTWSTask extends AsyncTask<String, Integer, String> {
    	...
    	public RESTWSTask(int taskType, Context mContext,String processMessage)
    	{

    		this.taskType = taskType;
    	this.mContext = mContext;
    		this.activity = (RestFulWebservice) mContext;
    	}
	...
	public void handleResponse(String response) {
		...
		TextView text;
		text = (TextView) findViewById(R.id.jsonResponse);
